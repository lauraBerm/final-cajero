...
const cuentaDestino = {
 ...
 function transferenciaBancaria(monto) {
      if (monto > 0 && monto <= cuentaOrigen.saldo) {
        cuentaOrigen.cuenta
    saldo -= monto;
 
    console.log(`Transferencia exitosa. Nuevo saldo: ${cuentaOrigen.saldo}`);
    ...
    const montoTransferencia = 500;
    
    transferenciaBancaria(montoTransferencia);
